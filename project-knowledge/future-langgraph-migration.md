# Миграция на LangGraph — исторический документ

> **Статус: АРХИВ — LangGraph уже реализован (2026-06).**  
> `LangGraphAgentService` активно используется в production. `PostgresSaver` обеспечивает персистентную историю диалогов.  
> Актуальная документация: `docs/ai-architecture/current-agent-architecture.md`.  
> Этот файл сохранён как исторический для понимания изначального дизайна.
